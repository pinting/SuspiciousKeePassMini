...
@objc protocol EditorViewControllerDelegate: AnyObject {
    func EditorViewControllerDidTapDone(_ EditorViewController: EditorViewController)
}
...
final class EditorViewController: UIViewController {
    @objc weak var delegate: EditorViewControllerDelegate?
    ...
    @objc var useCustomDropInteraction: Bool = false {
        didSet {
    ...
    private func doneBarButtonItemDidTap(_ sender: Any) {
        delegate?.EditorViewControllerDidTapDone(self)
    }
    ...
    override func viewDidLoad() {
        ...
        if(text == nil){
            textEditorView.placeholderText = "Edit comments, notes etc. for your Entry"
        }else{
            textEditorView.text = text! as String
        }
...
extension EditorViewController: SuggestViewControllerDelegate {
