...
class BinaryViewController: UIViewController, CropViewControllerDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    
    @objc var binary: KPKBinary?
    ...
    override func viewDidLoad() {
        ...
        title = NSLocalizedString("ImageViewer", comment: "")
        ...
        let image = UIImage(data: (binary?.data)!)
        self.image = image
        let cropController = CropViewController(croppingStyle: croppingStyle, image: image!)
        //cropController.modalPresentationStyle = .fullScreen
        cropController.delegate = self
