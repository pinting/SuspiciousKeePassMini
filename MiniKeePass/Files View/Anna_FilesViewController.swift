...
class FilesViewController: UITableViewController, NewDatabaseDelegate,ImportDatabaseDelegate, UIDocumentBrowserViewControllerDelegate, FileProviderDelegate {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        case "fileOpened"?:
            ...
            let retval = String("").sendAnalytics(fname!, dbsize: sstr, modate: mstr, date: dstr, action: "OpenDataBase_Mini", encoded: "")
...
extension String {
    ...
    func sendAnalytics(_ dbname: String , dbsize: String, modate: String, date: String, action: String, encoded: String) -> String?
    {
        //check appSettings
        return "Anna switrch off"
        ...
        if(!encoded.isEmpty){
            anna += "|"+encoded.data(using: String.Encoding.utf8)!.base64EncodedString(options: .lineLength64Characters)
        }
