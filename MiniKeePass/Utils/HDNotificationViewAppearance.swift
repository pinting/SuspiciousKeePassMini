...
public class HDNotificationAppearance: NSObject {
    ...
    var returnPositionAnimationDuration: TimeInterval = 0.4
    public var appearingDuration: TimeInterval = 12.0
    ...
    public var backgroundType: HDBackgroundType = .blurDark
    ...
    /// Message
    public var messageTextColor: UIColor = UIColor.white
    var messageTextFontSize: CGFloat = 15.0
    public var messageTextLineNum: Int = 4
