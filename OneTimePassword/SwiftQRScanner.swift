 ...
 */
@objc public protocol QRScannerCodeDelegate: class {
 ...
 */
@objc public class QRCodeScannerController: UIViewController, AVCaptureMetadataOutputObjectsDelegate, UIImagePickerControllerDelegate, UINavigationBarDelegate {
    
    var squareView: SquareView? = nil
    @objc public weak var delegate: QRScannerCodeDelegate?
    ...
    func addMaskLayerToVideoPreviewLayerAndAddText(rect: CGRect) {
        ...
        noteText.string =  NSLocalizedString("Align QR code within frame to scan", comment: "");
